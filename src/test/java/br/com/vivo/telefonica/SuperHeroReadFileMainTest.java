...
public class SuperHeroReadFileMainTest {
    ...
    private static final char DEFAULT_QUOTE_CHAR = SEMICOLON;
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL resource = SuperHeroReadFileMainTest.class.getClassLoader().getResource("/home/jorge.garcia/src/workspace-springtools/TestFileUpload/filesfile.csv");
        File file = Paths.get(resource.toURI()).toFile();

        SuperHeroReadFileMainTest obj = new SuperHeroReadFileMainTest();
    ...
    private List<String> parse(String line, char separator, char quoteChar)
        ...
        for (char c : line.toCharArray()) {
            ...
            if (c == SEMICOLON) {               // handle embedded double quotes ""
